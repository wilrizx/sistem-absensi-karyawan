!(function (e, t) {
  ...
  var p = (function (n) {
    ...
    function ae(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : y) !== x && C(t), (t = t || x), E)
      ) {
        if (11 !== f && (l = Z.exec(e)))
          if ((r = l[1])) {
            if (9 === f) {
      ...
      return (
        ...
        ue(function (e, t, n, i) {
          var r,
            ...
            f = g ? (v || (e ? d : u || m) ? [] : t) : h;
          if ((g && g(h, f, n, i), m))
            for (r = Ce(f, l), m(r, [], n, i), o = r.length; o--; )
              (s = r[o]) && (f[l[o]] = !(h[l[o]] = s));
          if (e) {
            if (v || d) {
              if (v) {
    ...
    return (
            ...
            (s = A(
              ...
              (i = function (e, t, n, i, r) {
                ...
                for (
                  ...
                  if (_ && o) {
                    for (
                      s = 0, t || o.ownerDocument === x || (C(o), (n = !E));
                      (a = m[s++]);
                ...
                if (((l += u), y && u !== l)) {
                  ...
                  if (e) {
                    if (0 < l) for (; u--; ) c[u] || h[u] || (h[u] = k.call(i));
                    h = Ce(h);
                  }
                  L.apply(i, h),
                    r &&
      ...
      (d.sortStable = T.split("").sort(N).join("") === T),
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!I(this, "string" == typeof e && A.test(e) ? T(e) : e || [], !1)
          .length;
      },
    });
  var k,
  ...
  ((T.fn.init = function (e, t, n) {
    ...
    return (
      (r = E.getElementById(i[2])) && ((this[0] = r), (this.length = 1)), this
    );
  }).prototype = T.fn),
    (k = T(E));
      ...
      function (i, r) {
        T.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (j[i] || T.uniqueSort(n), L.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
          ...
          s = {
            ...
            then: function (t, n, i) {
                    ...
                    e = function () {
                      ...
                      if (!(r < l)) {
                        ...
                        (t =
                          ...
                          y(t)
                            ? a
                              ? t.call(e, u(l, o, M, a), u(l, o, P, a))
                              : (l++,
                                t.call(
                                  e,
                                  u(l, o, M, a),
                                  u(l, o, P, a),
                                  u(l, o, M, o.notifyWith)
                                ))
                            : (s !== M && ((n = void 0), (i = [e])),
                              (a || o.resolveWith)(n, i));
                      }
              ...
              return T.Deferred(function (e) {
                o[0][3].add(u(0, e, y(i) ? i : M, e.notifyWith)),
                  o[1][3].add(u(0, e, y(t) ? t : M)),
  ...
  var ce = {};
  function he(e, t) {
    for (var n, i, r, o, s, a, l, u = [], c = 0, h = e.length; c < h; c++)
      (i = e[c]).style &&
        ((n = i.style.display),
        t
          ? ("none" === n &&
  ...
  function we(e, t, n, i, r) {
    ...
    for (h.textContent = "", d = 0; (o = f[d++]); )
      if (i && -1 < T.inArray(o, i)) r && r.push(o);
        ...
        ((u = oe(o)), (s = me(h.appendChild(o), "script")), u && ve(s), n)
      )
        for (c = 0; (o = s[c++]); ) pe.test(o.type || "") && n.push(o);
    return h;
  }
  (ye = E.createDocumentFragment().appendChild(E.createElement("div"))),
    (_e = E.createElement("input")).setAttribute("type", "radio"),
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[r]) {
              if (i.length)
                ...
                (t = o(this, r)),
                this[r](),
                i !== (n = Y.get(this, r)) || t ? Y.set(this, r, !1) : (n = {}),
                i !== n)
              )
                return (
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && D(t, "input") && Ne(t, "click", Te),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && D(t, "input") && Ne(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Pe(n, i, r, o) {
    ...
    var e,
      ...
      d = i[0],
      p = y(d);
    if (p || (1 < h && "string" == typeof d && !v.checkClone && Oe.test(d)))
    ...
    if (
      ...
      for (a = (s = T.map(me(e, "script"), Re)).length; c < h; c++)
        (l = e),
          c !== f &&
            ((l = T.clone(l, !0, !0)), a && T.merge(s, me(l, "script"))),
          r.call(n[c], l, c);
      if (a)
        for (u = s[s.length - 1].ownerDocument, T.map(s, He), c = 0; c < a; c++)
          (l = s[c]),
            pe.test(l.type || "") &&
  ...
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || me(e), s = s || me(c), i = 0, r = o.length; i < r; i++)
            Me(o[i], s[i]);
        else Me(e, c);
      return (
        0 < (s = me(c, "script")).length && ve(s, !h && me(e, "script")), c
      );
    },
      ...
      replaceWith: function () {
        ...
        return Pe(
          ...
          function (e) {
            ...
            T.inArray(this, n) < 0 &&
              (T.cleanData(me(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          u = e.style;
        if (
          (l || (t = Qe(a)), (s = T.cssHooks[t] || T.cssHooks[a]), void 0 === n)
        )
  ...
  function ut() {
    rt &&
      (!1 === E.hidden && x.requestAnimationFrame
        ? x.requestAnimationFrame(ut)
        : x.setTimeout(ut, T.fx.interval),
      T.fx.tick());
  }
  function ct() {
    return (
  ...
  function dt(o, e, t) {
    ...
    for (
      ...
      if ((n = dt.prefilters[i].call(u, o, c, u.opts)))
        return (
          y(n.stop) &&
  ...
  (T.Animation = T.extend(dt, {
    ...
    tweener: function (e, t) {
      for (
        var n, i = 0, r = (e = y(e) ? ((t = e), ["*"]) : e.match(H)).length;
        i < r;
        i++
      )
        (n = e[i]),
        ...
        if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(d))
          ...
          d))
            l ||
              ...
              g && he([e], !0),
              f.done(function () {
                for (i in (g || he([e]), Y.remove(e, "fxshow"), d))
                  T.style(e, i, d[i]);
              })),
              (l = ft(g ? m[i] : 0, i, f)),
              i in m ||
    ...
    (st = E.createElement("select").appendChild(E.createElement("option"))),
    (ot.type = "checkbox"),
    (v.checkOn = "" !== ot.value),
    ...
    T.fn.extend({
        ...
        return "boolean" == typeof t && s
          ...
          : this.each(function () {
              ...
              if (s)
                ...
                (void 0 !== r && "boolean" !== o) ||
                  ((e = _t(this)) && Y.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && -1 < (" " + yt(_t(n)) + " ").indexOf(t))
            return !0;
        return !1;
      },
    });
  ...
  T.extend(T.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !_(n)) {
          for (
            a = c.delegateType || d, Ct.test(a + d) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            f.push(o), (s = o);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (T.event.triggered = d),
              e.isPropagationStopped() && h.addEventListener(d, xt),
              n[d](),
              e.isPropagationStopped() && h.removeEventListener(d, xt),
    ...
    T.extend({
      ...
      ajax: function (e, t) {
        ...
        m.hasContent
          ...
          : ((o = m.url.slice(h.length)),
            m.data &&
              (m.processData || "string" == typeof m.data) &&
              ((h += (St.test(h) ? "&" : "?") + m.data), delete m.data),
            !1 === m.cache &&
              ((h = h.replace(jt, "$1")),
              (o = (St.test(h) ? "&" : "?") + "_=" + Tt++ + o)),
            (m.url = h + o)),
        m.ifModified &&
          (T.lastModified[h] &&
            C.setRequestHeader("If-Modified-Since", T.lastModified[h]),
          T.etag[h] && C.setRequestHeader("If-None-Match", T.etag[h])),
        ...
        function u(e, t, n, i) {
          ...
          p ||
            ...
            r
              ? (m.ifModified &&
                  ((l = C.getResponseHeader("Last-Modified")) &&
                    (T.lastModified[h] = l),
                  (l = C.getResponseHeader("etag")) && (T.etag[h] = l)),
                204 === e || "HEAD" === m.type
                  ? (u = "nocontent")
                  : 304 === e
                  ? (u = "notmodified")
            ...
            (C.status = e),
            (C.statusText = (t || u) + ""),
            r ? _.resolveWith(v, [o, u, C]) : _.rejectWith(v, [C, u, s]),
            C.statusCode(w),
            (w = void 0),
            g && y.trigger(r ? "ajaxSuccess" : "ajaxError", [C, m, r ? o : s]),
            b.fireWith(v, [C, u]),
            g &&
  ...
  T.ajaxSetup({
    ...
    (v.createHTMLDocument =
      (((Xt = E.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    T.each(["top", "left"], function (e, n) {
      T.cssHooks[n] = ze(v.pixelPosition, function (e, t) {
        if (t)
          return (t = Ue(e, n)), We.test(t) ? T(e).position()[n] + "px" : t;
      });
    }),
  ...
  (function (e, t) {
        ...
        return (
          (e.toggle = function () {
              ...
              if (i) {
                ...
                if (e) {
                  if (
                    ...
                    return;
                  (i.checked = !this._element.classList.contains(y)),
                    p(i).trigger("change");
                }
                i.focus(), (t = !1);
              }
            ...
            t &&
              ...
              e && p(this._element).toggleClass(y);
          }),
          (e.dispose = function () {
          ...
          (n._jQueryInterface = function (t) {
            return this.each(function () {
              var e = p(this).data(f);
              e || ((e = new n(this)), p(this).data(f, e)),
                "toggle" === t && e[t]();
            });
          }),
          s(n, null, [
        ...
        return (
          ...
          (o._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new o(this, t)), p(this).data(x, e)),
                "number" == typeof i)
              )
                e.to(i);
    ...
    p(document).on(
      ...
      (p.fn[C] = R._jQueryInterface),
      (p.fn[C].Constructor = R),
          ...
          (e.show = function () {
            ...
            if (
              ...
              if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                p(this._element).removeClass(z).addClass(V),
                ...
                p(this._element)
                  .one(g.TRANSITION_END, function () {
                    p(n._element).removeClass(V).addClass(z).addClass(U),
                      (n._element.style[r] = ""),
                      n.setTransitioning(!1),
                      p(n._element).trigger(B.SHOWN);
                  })
            ...
            if (!this._isTransitioning && p(this._element).hasClass(U)) {
              ...
              if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
                ...
                (this._element.style[n] =
                  ...
                  p(this._element).addClass(V).removeClass(z).removeClass(U);
                  ...
                  for (var r = 0; r < i; r++) {
                    ...
                    null !== s &&
                      (p([].slice.call(document.querySelectorAll(s))).hasClass(
                        ...
                        p(o).addClass($).attr("aria-expanded", !1));
                  }
    ...
    p(document).on(B.CLICK_DATA_API, X, function (e) {
      ...
      (p.fn[H] = Q._jQueryInterface),
      (p.fn[H].Constructor = Q),
      (p.fn[H].noConflict = function () {
    ...
    function ae(e) {
      ...
      for (
        var t = se(10) ? document.body : null, n = e.offsetParent || null;
    ...
    function ue(e, t) {
      ...
      if ((e !== l && t !== l) || i.contains(r))
        return "BODY" === (a = (s = l).nodeName) ||
          ("HTML" !== a && ae(s.firstElementChild) !== s)
          ? ae(l)
          : l;
      var u = le(e);
    ...
    function De(e, n, t) {
      return (
        (void 0 === t
          ...
          e.enabled &&
            ee(t) &&
            ((n.offsets.popper = ve(n.offsets.popper)),
            (n.offsets.reference = ve(n.offsets.reference)),
            (n = t(n, e)));
        }),
        n
      );
          ...
          arrow: {
            ...
            fn: function (e, t) {
              ...
              var r = e.placement.split("-")[0],
                ...
                d = l ? "bottom" : "right",
                p = Ee(i)[u];
              a[d] - p < s[h] && (e.offsets.popper[h] -= s[h] - (a[d] - p)),
                a[h] + p > s[d] && (e.offsets.popper[h] += a[h] + p - s[d]),
                (e.offsets.popper = ve(e.offsets.popper));
              var g = a[h] + a[u] / 2 - p / 2,
                ...
                b.forEach(function (e, t) {
                  ...
                  (s || h || d) &&
                    ...
                    (p.offsets.popper = me(
                      {},
                      p.offsets.popper,
                      Se(p.instance.popper, p.offsets.reference, p.placement)
                    )),
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var s,
                ...
                b,
                w,
                C = void 0 !== o ? o : t.gpuAcceleration,
                x = ae(e.instance.popper),
                E = ye(x),
                T = { position: r.position },
                S =
                  ((s = e),
                  (a = window.devicePixelRatio < 2 || !je),
                  (u = (l = s.offsets).popper),
                  (c = l.reference),
                  (h = Math.round),
                  (f = Math.floor),
                  (d = function (e) {
                  ...
                  (_ = a ? h : d),
                  {
                    left: (y = a ? (m || v || p % 2 == g % 2 ? h : f) : d)(
                      p % 2 == 1 && g % 2 == 1 && !v && a ? u.left - 1 : u.left
                    ),
                    top: _(u.top),
                    bottom: _(u.bottom),
                    right: y(u.right),
              ...
              if (
                ((w =
                  "bottom" === A
                    ? "HTML" === x.nodeName
                      ? -x.clientHeight + S.bottom
                      : -E.height + S.bottom
                    : S.top),
                (b =
                  "right" === D
                    ? "HTML" === x.nodeName
                      ? -x.clientWidth + S.right
                      : -E.width + S.right
                    : S.left),
                C && N)
              )
                (T[N] = "translate3d(" + b + "px, " + w + "px, 0)"),
                  (T[A] = 0),
                  (T[D] = 0),
              ...
              return (
                (e.attributes = me({}, O, e.attributes)),
                (e.styles = me({}, T, e.styles)),
      ...
      We = (function () {
        function o(e, t) {
          ...
          !(function (e, t) {
            ...
            Object.keys(me({}, o.Defaults.modifiers, i.modifiers)).forEach(
              function (e) {
                ...
                return function () {
                  this.state.eventsEnabled ||
                    (this.state = (function (e, t, n, i) {
                      (n.updateBound = i),
                        ke(e).addEventListener("resize", n.updateBound, {
                          passive: !0,
                        });
                      var r = ie(e);
                      return (
                ...
                return function () {
                  ...
                  this.state.eventsEnabled &&
                    ...
                    (this.state =
                      ((e = this.reference),
                      (t = this.state),
                      ke(e).removeEventListener("resize", t.updateBound),
    ...
    var Fe = "dropdown",
      ...
      tt = (function () {
        ...
        return (
              ...
              if ((u._clearMenus(), !t)) {
                ...
                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  "ontouchstart" in document.documentElement &&
                    ...
                    p(this._menu).toggleClass(Ke),
                    p(e).toggleClass(Ke).trigger(p.Event(Xe.SHOWN, n));
                }
              }
            }
          }),
          (e.show = function () {
            if (
              !(
                ...
                p(this._element).hasClass(Qe) ||
                p(this._menu).hasClass(Ke)
              )
            ) {
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(Ke),
                  p(n).toggleClass(Ke).trigger(p.Event(Xe.SHOWN, e)));
            }
          }),
          (e.hide = function () {
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(Ke),
                  p(n).toggleClass(Ke).trigger(p.Event(Xe.HIDDEN, e)));
            }
          }),
          (e.dispose = function () {
            p.removeData(this._element, Be),
              p(this._element).off(Ue),
              (this._element = null),
          ...
          (e._getConfig = function (e) {
            return (
              (e = l({}, this.constructor.Default, p(this._element).data(), e)),
              g.typeCheckConfig(Fe, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass("dropup")
                ? ((t = "top-start"),
                  p(this._menu).hasClass(Ye) && (t = "top-end"))
                : e.hasClass("dropright")
                ? (t = "right-start")
                : e.hasClass("dropleft")
                ? (t = "left-start")
                : p(this._menu).hasClass(Ye) && (t = "bottom-end"),
              t
            );
          }),
                  ...
                  if (
                    ...
                    p(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ...
                        p(a).removeClass(Ke),
                        p(r).removeClass(Ke).trigger(p.Event(Xe.HIDDEN, s)));
                  }
                }
              }
          }),
                ...
                ? !(
                    ...
                    (27 !== e.which &&
                      ((40 !== e.which && 38 !== e.which) ||
                        p(e.target).closest(Je).length))
                  )
                : $e.test(e.which)) &&
              (e.preventDefault(),
              e.stopPropagation(),
              !this.disabled && !p(this).hasClass(Qe))
            ) {
    ...
    p(document)
      .on(Xe.KEYDOWN_DATA_API, Ge, tt._dataApiKeydownHandler)
      .on(Xe.KEYDOWN_DATA_API, Je, tt._dataApiKeydownHandler)
      .on(Xe.CLICK_DATA_API + " " + Xe.KEYUP_DATA_API, tt._clearMenus)
      .on(Xe.CLICK_DATA_API, Ge, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
      ...
      (p.fn[Fe] = tt._jQueryInterface),
      (p.fn[Fe].Constructor = tt),
        ...
        return (
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  p(this._element).removeClass(ht),
          ...
          (e._showElement = function (e) {
            ...
            (this._element.parentNode &&
              ...
              p(this._element).addClass(ht),
              this._config.focus && this._enforceFocus();
            var i = p.Event(lt.SHOWN, { relatedTarget: e }),
              r = function () {
          ...
          (e._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                p(document.body).removeClass(ut),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
    ...
    p(document).on(lt.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      (p.fn[nt] = pt._jQueryInterface),
      (p.fn[nt].Constructor = pt),
        ...
        return (
          ...
          (e.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                if (p(this.getTipElement()).hasClass(Ot))
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              p(r).data(this.constructor.DATA_KEY, this),
                ...
                (this._popper = new We(this.element, r, {
                  placement: a,
                  modifiers: {
                    offset: this._getOffset(),
          ...
          (e._enter = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              e && (t._activeTrigger["focusin" === e.type ? jt : Lt] = !0),
              p(t.getTipElement()).hasClass(Ot) || t._hoverState === Nt
                ? (t._hoverState = Nt)
          ...
          (e._leave = function (e, t) {
            ...
            (t = t || p(e.currentTarget).data(n)) ||
              ...
              p(e.currentTarget).data(n, t)),
              e && (t._activeTrigger["focusout" === e.type ? jt : Lt] = !1),
          ...
          (e._getConfig = function (e) {
            ...
            return (
              ...
              g.typeCheckConfig(_t, e, this.constructor.DefaultType),
              e.sanitize &&
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new i(this, t)), p(this).data(bt, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[_t] = Rt._jQueryInterface),
      (p.fn[_t].Constructor = Rt),
    ...
    var Ht = "popover",
      ...
      Ut = l({}, Rt.DefaultType, { content: "(string|element|function)" }),
      zt = {
        HIDE: "hide" + Pt,
        HIDDEN: "hidden" + Pt,
        SHOW: "show" + Pt,
        ...
        return (
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), p(this).data(Mt, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Ht] = Vt._jQueryInterface),
      (p.fn[Ht].Constructor = Vt),
    ...
    var $t = "scrollspy",
      ...
      Gt = { offset: "number", method: "string", target: "(string|element)" },
      Jt = {
      ...
      on = (function () {
        function n(e, t) {
          ...
          (this._element = e),
            ...
            p(this._scrollElement).on(Jt.SCROLL, function (e) {
              return n._process(e);
            }),
            this.refresh(),
            this._process();
        ...
        return (
          ...
          (e.dispose = function () {
            p.removeData(this._element, Xt),
              p(this._scrollElement).off(Qt),
              (this._element = null),
          ...
          (e._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = l({}, Yt, "object" == typeof e && e ? e : {})).target
            ) {
              var t = p(e.target).attr("id");
              t || ((t = g.getUID($t)), p(e.target).attr("id", t)),
                (e.target = "#" + t);
            }
          ...
          (e._activate = function (t) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(Zt),
                n.addClass(Zt))
              : (n.addClass(Zt),
                n
                  .parents(en)
                  .prev(tn + ", " + nn)
                  .addClass(Zt),
                n.parents(en).prev(".nav-item").children(tn).addClass(Zt)),
              p(this._scrollElement).trigger(Jt.ACTIVATE, { relatedTarget: t });
          }),
          (e._clear = function () {
            [].slice
              .call(document.querySelectorAll(this._selector))
    ...
    p(window).on(Jt.LOAD_DATA_API, function () {
      ...
      (p.fn[$t] = on._jQueryInterface),
      (p.fn[$t].Constructor = on),
        ...
        return (
          (e.show = function () {
            ...
            if (
              ...
              var s = p.Event(un.HIDE, { relatedTarget: this._element }),
                a = p.Event(un.SHOW, { relatedTarget: i });
              if (
                (i && p(i).trigger(s),
                ...
                var l = function () {
                  var e = p.Event(un.HIDDEN, { relatedTarget: n._element }),
                    t = p.Event(un.SHOWN, { relatedTarget: i });
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = p(this),
                t = e.data(sn);
              if (
                (t || ((t = new i(this)), e.data(sn, t)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
                t[n]();
    ...
    p(document).on(
      ...
      (p.fn.tab = dn._jQueryInterface),
      (p.fn.tab.Constructor = dn),
        ...
        return (
          ...
          (e.hide = function (e) {
            ...
            this._element.classList.contains(_n) &&
              (p(this._element).trigger(yn.HIDE),
              e
                ? this._close()
          ...
          (e.dispose = function () {
            clearTimeout(this._timeout),
              ...
              p(this._element).off(yn.CLICK_DISMISS),
          ...
          (e._getConfig = function (e) {
            return (
              ...
              g.typeCheckConfig(pn, e, this.constructor.DefaultType),
              e
            );
          }),
          (e._setListeners = function () {
            ...
            var e = this,
              t = function () {
                e._element.classList.add("hide"),
                  p(e._element).trigger(yn.HIDDEN);
              };
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (t ||
                  ((t = new i(this, "object" == typeof n && n)), e.data(gn, t)),
                "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[pn] = xn._jQueryInterface),
      (p.fn[pn].Constructor = xn),
  ...
  (function (e, t) {
    ...
    (s = jQuery),
      ...
      (c = (function () {
        ...
        return (
              ...
              s(this._element)
                ...
                .on(u.CLICK_DATA_API, function (e) {
                  var t = s(this),
                    ...
                    i = n
                      .siblings(o._config.parentTrigger)
                      .children(o._config.triggerElement),
                    r = n.children(o._config.subMenu);
                  o._config.preventDefault && e.preventDefault(),
                    "true" !== t.attr("aria-disabled") &&
                      (n.hasClass(o._config.activeClass)
                        ? (t.attr("aria-expanded", !1), o._hide(r))
                        : (o._show(r),
                          t.attr("aria-expanded", !0),
                          o._config.toggle && i.attr("aria-expanded", !1)),
                      o._config.onTransitionStart &&
                        o._config.onTransitionStart(e));
                });
          }),
          (r.prototype._show = function (e) {
            if (
              !this._transitioning &&
              !s(e).hasClass(this._config.collapsingClass)
            ) {
              var t = this,
                n = s(e),
                i = s.Event(u.SHOW);
              if ((n.trigger(i), !i.isDefaultPrevented())) {
                ...
                var r = function () {
                  n
                    .removeClass(t._config.collapsingClass)
                    .addClass(
                      t._config.collapseClass + " " + t._config.collapseInClass
                    )
                    .height("")
                    .attr("aria-expanded", !0),
          ...
          (r.prototype._hide = function (e) {
            if (
              !this._transitioning &&
              s(e).hasClass(this._config.collapseInClass)
            ) {
              var t = this,
                n = s(e),
                i = s.Event(u.HIDE);
              if ((n.trigger(i), !i.isDefaultPrevented())) {
                ...
                var r = function () {
                  t._transitioning &&
                    t._config.onTransitionEnd &&
                    t._config.onTransitionEnd(),
                    t.setTransitioning(!1),
                    n.trigger(u.HIDDEN),
                    n
                      .removeClass(t._config.collapsingClass)
                      .addClass(t._config.collapseClass)
                      .attr("aria-expanded", !1);
                };
                h.supportsTransitionEnd()
                  ? 0 == n.height() || "none" == n.css("display")
                    ? r()
                    : n
                        .height(0)
                        .one(h.TRANSITION_END, r)
            ...
            return this.each(function () {
              var e = s(this),
                ...
                n = s.extend(
                  ...
                  l,
                  e.data(),
                  "object" === (void 0 === i ? "undefined" : o(i)) && i
                );
              if (
                (!t && /dispose/.test(i) && this.dispose(),
                t || ((t = new r(this, n)), e.data(a, t)),
                "string" == typeof i)
              ) {
                if (void 0 === t[i])
      ...
      (s.fn[n] = c._jQueryInterface),
      (s.fn[n].Constructor = c),
    ...
    (e = function (R) {
      ...
      (e = function () {
            ...
            render: function (e, t, n) {
              ...
              return this.format.replace(this.fre, function () {
                return (
                  (r = arguments[1]),
                  (o = arguments[3]),
                  (i = l.precre.exec(r)) ? ((a = i[2]), (r = i[1])) : (a = !1),
                  (s = u[r]) === U
                    ? ""
                    : o && t && t[o]
                    ? t[o].get
                      ...
                      : t[o][s] || s
                    : (c(s) &&
                        (s = n.get("numberFormatter")
                          ? n.get("numberFormatter")(s)
                          : h(
                              s,
                              a,
                              n.get("numberDigitGroupCount"),
                              n.get("numberDigitGroupSep"),
                              n.get("numberDecimalMark")
                            )),
                      s)
                );
              });
        ...
        (b = function (e, t) {
          var n;
          return 2 === t
            ? ((n = B.floor(e.length / 2)),
              e.length % 2 ? e[n] : (e[n - 1] + e[n]) / 2)
            : e.length % 2
            ? (n = (e.length * t + t) / 4) % 1
              ? (e[B.floor(n)] + e[B.floor(n) - 1]) / 2
              : e[n - 1]
            : (n = (e.length * t + 2) / 4) % 1
            ? (e[B.floor(n)] + e[B.floor(n) - 1]) / 2
            : e[n - 1];
        ...
        (h = function (e, t, n, i, r) {
          var o, s;
          for (
            e = (!1 === t ? parseFloat(e).toString() : e.toFixed(t)).split(""),
              (o = (o = R.inArray(".", e)) < 0 ? e.length : o) < e.length &&
                (e[o] = r),
              s = o - n;
            0 < s;
            s -= n
        ...
        (n = function (e) {
          ...
          ((t = E.createElement("style")).type = "text/css"),
            ...
            n
              ? (E.styleSheets[E.styleSheets.length - 1].cssText = e)
              : (t[
                  "string" == typeof E.body.style.WebkitAppearance
                    ? "innerText"
                    : "innerHTML"
                ] = e);
        }),
        (R.fn.simpledraw = function (e, t, n, i) {
          ...
          if (R.fn.sparkline.canvas === U) {
            ...
            if (s.getContext && s.getContext("2d"))
              R.fn.sparkline.canvas = function (e, t, n, i) {
                return new g(e, t, n, i);
              };
            else {
              if (!E.namespaces || E.namespaces.v)
          ...
          return (
            e === U && (e = R(this).innerWidth()),
            t === U && (t = R(this).innerHeight()),
            (r = R.fn.sparkline.canvas(e, t, this, i)),
            (o = R(this).data("_jqs_mhandler")) && o.registerCanvas(r),
            r
          );
        }),
            ...
            init: function (e) {
              ...
              for (t in e)
                e.hasOwnProperty(t) &&
                  ...
                  -1 < t.indexOf(":") &&
                  (((n = t.split(":"))[0] =
                    0 === n[0].length ? -1 / 0 : parseFloat(n[0])),
                  (n[1] = 0 === n[1].length ? 1 / 0 : parseFloat(n[1])),
                  (n[2] = e[t]),
                  i.push(n));
        ...
        (f = t({
          ...
          registerCanvas: function (e) {
            var t = R(e.canvas);
            (this.canvas = e),
              (this.$canvas = t).mouseenter(R.proxy(this.mouseenter, this)),
              t.mouseleave(R.proxy(this.mouseleave, this)),
              t.click(R.proxy(this.mouseclick, this));
          },
          reset: function (e) {
            (this.splist = []),
              this.tooltip && e && (this.tooltip.remove(), (this.tooltip = U));
          },
          ...
          mouseenter: function (e) {
            R(E.body).unbind("mousemove.jqs"),
              ...
              !this.tooltip &&
                ...
                ((this.tooltip = new i(this.options)),
          ...
          updateDisplay: function () {
            ...
            if (this.over) {
              for (t = 0; t < o; t++)
                (n = r[t].setRegionHighlight(this.currentEl, l, u)) && (s = !0);
              if (s) {
                if (
                  (((i = R.Event("sparklineRegionChange")).sparklines =
                    this.splist),
                  this.$el.trigger(i),
                  this.tooltip)
                ) {
                  for (e = "", t = 0; t < o; t++)
                    e += r[t].getCurrentRegionTooltip();
        ...
        (i = t({
          ...
          init: function (e) {
            var t,
              n = e.get("tooltipClassname", "jqstooltip"),
              i = this.sizeStyle;
            (this.container = e.get("tooltipContainer") || E.body),
              ...
              R(window).bind(
                ...
                R.proxy(this.updateWindowDims, this)
              ),
        ...
        (y = []),
        (R.fn.sparkline = function (u, n) {
          return this.each(function () {
            var e,
              t,
              a = new R.fn.sparkline.options(this, n),
              l = R(this);
            if (
              ((e = function () {
                var e, t, n, i, r, o, s;
                (e =
                  "html" === u || u === U
                    ? (((s = this.getAttribute(a.get("tagValuesAttribute"))) !==
                        U &&
                        null !== s) ||
                        (s = l.html()),
                      s.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(","))
                    : u),
                  (t =
                    "auto" === a.get("width")
                      ? e.length * a.get("defaultPixelsPerValue")
                      : a.get("width")),
                  "auto" === a.get("height")
                    ? (a.get("composite") && R.data(this, "_jqs_vcanvas")) ||
                      (((i = E.createElement("span")).innerHTML = "a"),
                      l.html(i),
                      (n = R(i).innerHeight() || R(i).height()),
                      R(i).remove(),
                      (i = null))
                    : (n = a.get("height")),
                  a.get("disableInteraction")
                    ? (r = !1)
                    : (r = R.data(this, "_jqs_mhandler"))
                    ? a.get("composite") || r.reset()
                    : ((r = new f(this, a)), R.data(this, "_jqs_mhandler", r)),
                  !a.get("composite") || R.data(this, "_jqs_vcanvas")
                    ? ((o = new R.fn.sparkline[a.get("type")](
                        this,
                        e,
                        a,
                        t,
                      ...
                      r && r.registerSparkline(o))
                    : R.data(this, "_jqs_errnotify") ||
                      (alert(
              ...
              (R(this).html() &&
                !a.get("disableHiddenCheck") &&
                R(this).is(":hidden")) ||
                !R(this).parents("body").length)
            ) {
              if (!a.get("composite") && R.data(this, "_jqs_pending"))
                for (t = y.length; t; t--)
                  y[t - 1][0] == this && y.splice(t - 1, 1);
              y.push([this, e]), R.data(this, "_jqs_pending", !0);
            } else e.call(this);
          });
        }),
        (R.fn.sparkline.defaults = e()),
        (R.sparkline_display_visible = function () {
          ...
          for (t = 0, n = y.length; t < n; t++)
            (e = y[t][0]),
              R(e).is(":visible") && !R(e).parents().is(":hidden")
                ? (y[t][1].call(e),
                  R.data(y[t][0], "_jqs_pending", !1),
                  i.push(t))
                : R(e).closest("html").length ||
                  R.data(e, "_jqs_pending") ||
                  (R.data(y[t][0], "_jqs_pending", !1), i.push(t));
        ...
        (R.fn.sparkline.options = t({
          init: function (e, t) {
            ...
            (this.userOptions = t = t || {}),
              (this.tag = e),
              (this.tagValCache = {}),
              (r = (i = R.fn.sparkline.defaults).common),
              (this.tagOptionsPrefix =
                t.enableTagOptions &&
                (t.tagOptionsPrefix || r.tagOptionsPrefix)),
              (n =
                (o = this.getTagSetting("type")) === _
                  ? i[t.type || r.type]
                  : i[o]),
              (this.mergedOptions = R.extend({}, r, n, t));
          },
          getTagSetting: function (e) {
            ...
            if (this.tagValCache.hasOwnProperty(e)) t = this.tagValCache.key;
              ...
              if ((t = this.tag.getAttribute(o + e)) === U || null === t) t = _;
                ...
                for (
                  n = (t = t.substr(1, t.length - 2).split(",")).length;
                  n--;

                )
                  t[n] = M(t[n].replace(/(^\s*)|(\s*$)/g, ""));
              else if ("{" === t.substr(0, 1))
                for (
                  i = t.substr(1, t.length - 2).split(","),
                    t = {},
                    n = i.length;
                  n--;

                )
                  t[(r = i[n].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] =
                    M(r[1].replace(/(^\s*)|(\s*$)/g, ""));
              else t = M(t);
        ...
        (R.fn.sparkline._base = t({
          ...
          setRegionHighlight: function (e, t, n) {
            ...
            return t > this.canvasWidth ||
              ...
              n < 0
              ? null
              : r !== (i = this.getRegion(e, t, n)) &&
                  (r !== U && o && this.removeHighlight(),
                  (this.currentRegion = i) !== U && o && this.renderHighlight(),
                  !0);
          },
          clearRegionHighlight: function () {
            return (
              this.currentRegion !== U &&
              (this.removeHighlight(), !(this.currentRegion = U))
            );
          },
          ...
          getCurrentRegionTooltip: function () {
            ...
            if (
              ((e = this.getCurrentRegionFields()),
              (c = p.get("tooltipFormatter")))
            )
              return c(this, p, e);
            if (
              (p.get("tooltipChartTitle") &&
                (g +=
                  '<div class="jqs jqstitle">' +
                  p.get("tooltipChartTitle") +
                  "</div>\n"),
              !(t = this.options.get("tooltipFormat")))
            )
              return "";
            if (
              (R.isArray(t) || (t = [t]),
              R.isArray(e) || (e = [e]),
              (s = this.options.get("tooltipFormatFieldlist")),
              (a = this.options.get("tooltipFormatFieldlistKey")),
              s && a)
            ) {
              for (l = [], o = e.length; o--; )
                (u = e[o][a]), -1 != (d = R.inArray(u, s)) && (l[d] = e[o]);
              e = l;
            }
            for (n = t.length, f = e.length, o = 0; o < n; o++)
              for (
                "string" == typeof (h = t[o]) && (h = new v(h)),
                  i = h.fclass || "jqsfield",
                  d = 0;
                d < f;
                d++
              )
                (e[d].isNull && p.get("tooltipSkipNull")) ||
                  (R.extend(e[d], {
                    prefix: p.get("tooltipPrefix"),
                    suffix: p.get("tooltipSuffix"),
                  }),
                  (r = h.render(e[d], p.get("tooltipValueLookups"), p)),
                  m.push('<div class="' + i + '">' + r + "</div>"));
          ...
          calcHighlightColor: function (e, t) {
            var n,
              ...
              r,
              o,
              s = t.get("highlightColor"),
              a = t.get("highlightLighten");
            if (s) return s;
            if (
              a &&
              (n =
                /^#([0-9a-f])([0-9a-f])([0-9a-f])$/i.exec(e) ||
                /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(e))
            ) {
              for (r = [], i = 4 === e.length ? 16 : 1, o = 0; o < 3; o++)
                r[o] = H(B.round(parseInt(n[o + 1], 16) * i * a), 0, 255);
              return "rgb(" + r.join(",") + ")";
            }
            return e;
          },
        ...
        (r = {
          changeHighlight: function (e) {
            ...
            r &&
              ...
              R.isArray(t) || R.isArray(r)
                ? (i.replaceWithShapes(r, t),
                  (this.regionShapes[n] = R.map(t, function (e) {
                    return e.id;
                  })))
        ...
        (R.fn.sparkline.line = k =
          t(R.fn.sparkline._base, {
            type: "line",
            init: function (e, t, n, i, r) {
              k._super.init.call(this, e, t, n, i, r),
                (this.vertices = []),
                (this.regionMap = []),
                (this.xvalues = []),
                (this.yvalues = []),
            ...
            renderHighlight: function () {
              ...
              r &&
                (s &&
                  a &&
                  ((e = i.drawCircle(r[0], r[1], s, U, a)),
                  (this.highlightSpotId = e.id),
                  i.insertAfterShape(this.lastShapeId, e)),
                l &&
                  ((t = i.drawLine(
                    r[0],
                    this.canvasTop,
                  ...
                  i.insertAfterShape(this.lastShapeId, t)));
            },
            removeHighlight: function () {
              var e = this.target;
            ...
            scanValues: function () {
              ...
              for (e = 0; e < s; e++)
                (t = o[e]),
                  (n = "string" == typeof o[e]),
                  (i = "object" == typeof o[e] && o[e] instanceof Array),
                  (r = n && o[e].split(":")),
                  n && 2 === r.length
                    ? (a.push(Number(r[0])),
                      l.push(Number(r[1])),
                      u.push(Number(r[1])))
                    : i
                    ? (a.push(t[0]), l.push(t[1]), u.push(t[1]))
                    : (a.push(e),
                      null === o[e] || "null" === o[e]
                        ? l.push(null)
                        : (l.push(Number(t)), u.push(Number(t))));
              this.options.get("xvalues") && (a = this.options.get("xvalues")),
                (this.maxy = this.maxyorg = B.max.apply(B, u)),
                (this.miny = this.minyorg = B.min.apply(B, u)),
                (this.maxx = B.max.apply(B, a)),
                (this.minx = B.min.apply(B, a)),
                (this.xvalues = a),
                (this.yvalues = l),
                (this.yminmax = u);
            },
            processRangeOptions: function () {
              ...
              t !== U &&
                ...
                n > this.maxy && (this.maxy = n)),
                e.get("chartRangeMin") !== U &&
                  (e.get("chartRangeClip") ||
                    e.get("chartRangeMin") < this.miny) &&
                  (this.miny = e.get("chartRangeMin")),
                e.get("chartRangeMax") !== U &&
                  (e.get("chartRangeClip") ||
                    e.get("chartRangeMax") > this.maxy) &&
                  (this.maxy = e.get("chartRangeMax")),
                e.get("chartRangeMinX") !== U &&
                  (e.get("chartRangeClipX") ||
                    e.get("chartRangeMinX") < this.minx) &&
                  (this.minx = e.get("chartRangeMinX")),
                e.get("chartRangeMaxX") !== U &&
                  (e.get("chartRangeClipX") ||
                    e.get("chartRangeMaxX") > this.maxx) &&
            ...
            drawNormalRange: function (e, t, n, i, r) {
              var o = this.options.get("normalRangeMin"),
                ...
                l = B.round((n * (s - o)) / r);
              this.target
                .drawRect(e, a, i, l, U, this.options.get("normalRangeColor"))
                .append();
            },
            render: function () {
              var e,
              ...
              if (
                ...
                for (
                  i = r = 0,
                    ...
                    t = this.maxy - this.miny == 0 ? 1 : this.maxy - this.miny,
                    n = this.yvalues.length - 1,
                    N && (S < 4 * N || A < 4 * N) && (N = 0),
                    N &&
                      (((_ =
                        E.get("highlightSpotColor") &&
                        !E.get("disableInteraction")) ||
                        E.get("minSpotColor") ||
                        (E.get("spotColor") && C[n] === this.miny)) &&
                        (A -= B.ceil(N)),
                      (_ ||
                        E.get("maxSpotColor") ||
                        (E.get("spotColor") && C[n] === this.maxy)) &&
                        ((A -= B.ceil(N)), (i += B.ceil(N))),
                      (_ ||
                        ((E.get("minSpotColor") || E.get("maxSpotColor")) &&
                          (C[0] === this.miny || C[0] === this.maxy))) &&
                        ((r += B.ceil(N)), (S -= B.ceil(N))),
                      (_ ||
                        E.get("spotColor") ||
                        E.get("minSpotColor") ||
                        (E.get("maxSpotColor") &&
                          (C[n] === this.miny || C[n] === this.maxy))) &&
                        (S -= B.ceil(N))),
                    A--,
                    E.get("normalRangeMin") === U ||
                      E.get("drawNormalOnTop") ||
                      this.drawNormalRange(r, i, A, S, t),
                    a = [(s = [])],
                    f = d = null,
                    p = C.length,
                    x = 0;
                  ...
                  (l = w[x]),
                    ...
                    (u = C[x]),
                    (d =
                      (h = r + B.round((l - this.minx) * (S / e))) +
                      ((x < p - 1
                        ? r + B.round((c - this.minx) * (S / e))
                        : S) -
                        h) /
                        2),
                    (I[x] = [f || 0, d, x]),
                    ...
                    null === u
                      ? x &&
                        (null !== C[x - 1] && ((s = []), a.push(s)),
                        D.push(null))
                      : (u < this.miny && (u = this.miny),
                        u > this.maxy && (u = this.maxy),
                        s.length || s.push([h, i + A]),
                        (o = [h, i + B.round(A - A * ((u - this.miny) / t))]),
                        s.push(o),
                        D.push(o));
                for (g = [], m = [], v = a.length, x = 0; x < v; x++)
                  (s = a[x]).length &&
                    (E.get("fillColor") &&
                      (s.push([s[s.length - 1][0], i + A]),
                      m.push(s.slice(0)),
                      s.pop()),
                    2 < s.length && (s[0] = [s[0][0], s[1][1]]),
                    g.push(s));
                for (v = m.length, x = 0; x < v; x++)
                  T.drawShape(
                    m[x],
                    E.get("fillColor"),
                    E.get("fillColor")
                ...
                if (N && E.get("valueSpots"))
                  for (
                    (y = E.get("valueSpots")).get === U && (y = new W(y)),
                      x = 0;
                    x < p;
                    x++
                  )
                    (b = y.get(C[x])) &&
                      T.drawCircle(
                        r + B.round((w[x] - this.minx) * (S / e)),
                        i + B.round(A - A * ((C[x] - this.miny) / t)),
                        N,
                        U,
                        b
                      ).append();
                N &&
                  ...
                  null !== C[n] &&
                  T.drawCircle(
                    r + B.round((w[w.length - 1] - this.minx) * (S / e)),
                    i + B.round(A - A * ((C[n] - this.miny) / t)),
                    N,
                    U,
                    E.get("spotColor")
                  ).append(),
                  this.maxy !== this.minyorg &&
                    (N &&
                      E.get("minSpotColor") &&
                      ((l = w[R.inArray(this.minyorg, C)]),
                      T.drawCircle(
                        r + B.round((l - this.minx) * (S / e)),
                        i + B.round(A - A * ((this.minyorg - this.miny) / t)),
                        N,
                        U,
                        E.get("minSpotColor")
                      ).append()),
                    N &&
                      E.get("maxSpotColor") &&
                      ((l = w[R.inArray(this.maxyorg, C)]),
                      T.drawCircle(
                        r + B.round((l - this.minx) * (S / e)),
                        i + B.round(A - A * ((this.maxyorg - this.miny) / t)),
                        N,
                        U,
                        E.get("maxSpotColor")
                      ).append())),
        ...
        (R.fn.sparkline.bar = F =
          t(R.fn.sparkline._base, r, {
            type: "bar",
            init: function (e, t, n, i, r) {
              var o,
                s,
                ...
                O = -1 / 0;
              for (
                F._super.init.call(this, e, t, n, i, r), c = 0, h = t.length;
                c < h;
                c++
              )
                ((o = "string" == typeof (E = t[c]) && -1 < E.indexOf(":")) ||
                  R.isArray(E)) &&
                  ((_ = !0),
                  o && (E = t[c] = P(E.split(":"))),
                  (E = q(E, null)),
                  (s = B.min.apply(B, E)) < k && (k = s),
                  O < (a = B.max.apply(B, E)) && (O = a));
              (this.stacked = _),
                (this.regionShapes = {}),
                (this.barWidth = S),
                (this.barSpacing = A),
                (this.totalBarWidth = S + A),
                (this.width = i = t.length * S + (t.length - 1) * A),
                this.initTarget(),
                I && ((v = D === U ? -1 / 0 : D), (y = N === U ? 1 / 0 : N)),
                (u = []),
                (l = _ ? [] : u);
              var L = [],
                j = [];
              for (c = 0, h = t.length; c < h; c++)
                if (_)
                  ...
                  (E = I ? H(t[c], v, y) : t[c]),
                    null !== (E = t[c] = M(E)) && u.push(E);
              (this.max = m = B.max.apply(B, u)),
                (this.min = g = B.min.apply(B, u)),
                (this.stackMax = O = _ ? B.max.apply(B, L) : m),
                (this.stackMin = k = _ ? B.min.apply(B, u) : g),
                n.get("chartRangeMin") !== U &&
                  (n.get("chartRangeClip") || n.get("chartRangeMin") < g) &&
                  (g = n.get("chartRangeMin")),
                n.get("chartRangeMax") !== U &&
                  (n.get("chartRangeClip") || n.get("chartRangeMax") > m) &&
                  (m = n.get("chartRangeMax")),
                (this.zeroAxis = d = n.get("zeroAxis", !0)),
                (p = g <= 0 && 0 <= m && d ? 0 : 0 == d ? g : 0 < g ? g : m),
                (this.xaxisOffset = p),
                (f = _ ? B.max.apply(B, l) + B.max.apply(B, j) : m - g),
                (this.canvasHeightEf =
                  d && g < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
                g < p
                  ? (T =
                      (((_ && 0 <= m ? O : m) - p) / f) * this.canvasHeight) !==
                      B.ceil(T) && ((this.canvasHeightEf -= 2), (T = B.ceil(T)))
                  : (T = this.canvasHeight),
                (this.yoffset = T),
                R.isArray(n.get("colorMap"))
                  ? ((this.colorMapByIndex = n.get("colorMap")),
                    (this.colorMapByValue = null))
                  : ((this.colorMapByIndex = null),
                    (this.colorMapByValue = n.get("colorMap")),
                    this.colorMapByValue &&
                      this.colorMapByValue.get === U &&
                      (this.colorMapByValue = new W(this.colorMapByValue))),
                (this.range = f);
            },
            getRegion: function (e, t, n) {
            ...
            calcColor: function (e, t, n) {
              ...
              return (
                (i = this.stacked
                  ? a.get("stackedBarColor")
                  : t < 0
                  ? a.get("negBarColor")
                  : a.get("barColor")),
                0 === t && a.get("zeroColor") !== U && (i = a.get("zeroColor")),
                s && (r = s.get(t)) ? (i = r) : o && o.length > n && (i = o[n]),
                R.isArray(i) ? i[e % i.length] : i
              );
            },
            renderRegion: function (e, t) {
              var n,
                ...
                w = this.yoffset;
              if (
                ((l = (f = R.isArray(f) ? f : [f]).length),
                (u = f[0]),
                (o = C(null, f)),
                (h = C(p, f, !0)),
                o)
              )
                return d.get("nullColor")
                  ? ((r = t
                      ? d.get("nullColor")
                      : this.calcHighlightColor(d.get("nullColor"), d)),
                    (n = 0 < w ? w - 1 : w),
                    y.drawRect(_, n, this.barWidth - 1, 0, r, r))
                  : U;
              for (s = w, a = 0; a < l; a++) {
                if (((u = f[a]), v && u === p)) {
                  if (!h || c) continue;
                ...
                (i = 0 < m ? B.floor(b * (B.abs(u - p) / m)) + 1 : 1),
                  u < p || (u === p && 0 === w)
                    ? ((n = s), (s += i))
                    : ((n = w - i), (w -= i)),
                  (r = this.calcColor(a, u, e)),
                  t && (r = this.calcHighlightColor(r, d)),
                  g.push(y.drawRect(_, n, this.barWidth - 1, i - 1, r, r));
              }
              return 1 === g.length ? g[0] : g;
            },
          })),
        (R.fn.sparkline.tristate = a =
          t(R.fn.sparkline._base, r, {
            type: "tristate",
            init: function (e, t, n, i, r) {
              var o = parseInt(n.get("barWidth"), 10),
                s = parseInt(n.get("barSpacing"), 10);
              a._super.init.call(this, e, t, n, i, r),
                (this.regionShapes = {}),
                (this.barWidth = o),
                (this.barSpacing = s),
                (this.totalBarWidth = o + s),
                (this.values = R.map(t, Number)),
                (this.width = i = t.length * o + (t.length - 1) * s),
                R.isArray(n.get("colorMap"))
                  ? ((this.colorMapByIndex = n.get("colorMap")),
                    (this.colorMapByValue = null))
                  : ((this.colorMapByIndex = null),
              ...
              if (
                ...
                (i =
                  l[e] < 0
                    ...
                    ? ((s = 0), r - 1)
                    : ((s = r - 1), 2)),
                null !== (a = this.calcColor(l[e], e)))
              )
                return (
                  t && (a = this.calcHighlightColor(a, u)),
                  c.drawRect(o, s, this.barWidth - 1, i - 1, a, a)
                );
            },
          })),
        (R.fn.sparkline.discrete = s =
          t(R.fn.sparkline._base, r, {
            type: "discrete",
            init: function (e, t, n, i, r) {
              s._super.init.call(this, e, t, n, i, r),
                (this.regionShapes = {}),
                (this.values = t = R.map(t, Number)),
                (this.min = B.min.apply(B, t)),
                (this.max = B.max.apply(B, t)),
                (this.range = this.max - this.min),
                (this.width = i =
                  "auto" === n.get("width") ? 2 * t.length : this.width),
                (this.interval = B.floor(i / t.length)),
                (this.itemWidth = i / t.length),
                n.get("chartRangeMin") !== U &&
            ...
            renderRegion: function (e, t) {
              ...
              return (
                ...
                (n = B.round(g - g * ((i - l) / c))),
                (r =
                  a.get("thresholdColor") && i < a.get("thresholdValue")
                    ? a.get("thresholdColor")
                    : a.get("lineColor")),
                t && (r = this.calcHighlightColor(r, a)),
                f.drawLine(o, n, o, n + p, r)
              );
            },
          })),
        (R.fn.sparkline.bullet = l =
          t(R.fn.sparkline._base, {
            type: "bullet",
            init: function (e, t, n, i, r) {
              var o, s, a;
              l._super.init.call(this, e, t, n, i, r),
                (this.values = t = P(t)),
                ((a = t.slice())[0] = null === a[0] ? a[2] : a[0]),
                (a[1] = null === t[1] ? a[2] : a[1]),
                (o = B.min.apply(B, t)),
                (s = B.max.apply(B, t)),
                (o = n.get("base") === U ? (o < 0 ? o : 0) : n.get("base")),
                (this.min = o),
                (this.max = s),
                (this.range = s - o),
                (this.shapes = {}),
                (this.valueShapes = {}),
                (this.regiondata = {}),
                (this.width = i = "auto" === n.get("width") ? "4.0em" : i),
                (this.target = this.$el.simpledraw(i, r, n.get("composite"))),
                t.length || (this.disabled = !0),
                this.initTarget();
            },
            getRegion: function (e, t, n) {
            ...
            renderRange: function (e, t) {
              ...
              return (
                ...
                this.target.drawRect(0, 0, i - 1, this.canvasHeight - 1, r, r)
              );
            },
            renderPerformance: function (e) {
              ...
              return (
                e && (i = this.calcHighlightColor(i, this.options)),
                this.target.drawRect(
                  0,
                  B.round(0.3 * this.canvasHeight),
                  n - 1,
                  B.round(0.4 * this.canvasHeight) - 1,
                  i,
                  i
                )
              );
            ...
            renderTarget: function (e) {
              var t = this.values[0],
                n = B.round(
                  this.canvasWidth * ((t - this.min) / this.range) -
                    this.options.get("targetWidth") / 2
                ),
                i = B.round(0.1 * this.canvasHeight),
                r = this.canvasHeight - 2 * i,
                o = this.options.get("targetColor");
              return (
                e && (o = this.calcHighlightColor(o, this.options)),
                this.target.drawRect(
                  n,
                  i,
            ...
            render: function () {
              ...
              if (l._super.render.call(this)) {
                for (e = 2; e < n; e++)
                  (t = this.renderRange(e).append()),
                    (this.shapes[t.id] = "r" + e),
                    (this.valueShapes["r" + e] = t.id);
                null !== this.values[1] &&
                  ((t = this.renderPerformance().append()),
                  (this.shapes[t.id] = "p1"),
                  (this.valueShapes.p1 = t.id)),
                  null !== this.values[0] &&
                    ((t = this.renderTarget().append()),
                    (this.shapes[t.id] = "t0"),
                    (this.valueShapes.t0 = t.id)),
                  i.render();
              }
            },
          })),
        (R.fn.sparkline.pie = u =
          t(R.fn.sparkline._base, {
            type: "pie",
            init: function (e, t, n, i, r) {
              var o,
                s = 0;
              if (
                (u._super.init.call(this, e, t, n, i, r),
                (this.shapes = {}),
                (this.valueShapes = {}),
                (this.values = t = R.map(t, Number)),
              ...
              return {
                ...
                color:
                  this.options.get("sliceColors")[
                    e % this.options.get("sliceColors").length
                  ],
                offset: e,
              };
            },
            changeHighlight: function (e) {
              ...
              delete this.shapes[i],
                this.target.replaceWithShape(i, n),
            ...
            renderSlice: function (e, t) {
              ...
              for (o = d.length, r = 0; r < o; r++) {
                if (((i = n = g), 0 < p && (i = g + f * (d[r] / p)), e === r))
                  return (
                    (s = l.get("sliceColors")[r % l.get("sliceColors").length]),
                    t && (s = this.calcHighlightColor(s, l)),
                    a.drawPieSlice(u, u, u - c, n, i, U, s)
                  );
                g = i;
              }
            },
              ...
              if (u._super.render.call(this)) {
                for (
                  ...
                  i[t] &&
                    ...
                    (this.valueShapes[t] = e.id),
                    (this.shapes[e.id] = t));
                n.render();
              }
            },
          })),
        (R.fn.sparkline.box = w =
          t(R.fn.sparkline._base, {
            type: "box",
            init: function (e, t, n, i, r) {
              w._super.init.call(this, e, t, n, i, r),
                (this.values = R.map(t, Number)),
                (this.width = "auto" === n.get("width") ? "4.0em" : i),
                this.initTarget(),
            ...
            render: function () {
              var e,
                ...
                m = this.canvasHeight,
                v =
                  p.get("chartRangeMin") === U
                    ? B.min.apply(B, f)
                    : p.get("chartRangeMin"),
                y =
                  p.get("chartRangeMax") === U
                    ? B.max.apply(B, f)
                    : p.get("chartRangeMax"),
                _ = 0;
              if (w._super.render.call(this)) {
                if (p.get("raw"))
                  p.get("showOutliers") && 5 < f.length
                    ? ((t = f[0]),
                      (e = f[1]),
                      (i = f[2]),
                      (r = f[3]),
                  ...
                  for (e = s = U, l = 0; l < d; l++)
                    e === U && f[l] > i - n * p.get("outlierIQR") && (e = f[l]),
                      f[l] < o + n * p.get("outlierIQR") && (s = f[l]);
                  (t = f[0]), (a = f[d - 1]);
                } else (e = f[0]), (s = f[d - 1]);
                (this.quartiles = [i, r, o]),
                  (this.lwhisker = e),
                  (this.rwhisker = s),
                  (this.loutlier = t),
                  (this.routlier = a),
                  (c = g / (y - v + 1)),
                  p.get("showOutliers") &&
                    ((_ = B.ceil(p.get("spotRadius"))),
                    (c = (g -= 2 * B.ceil(p.get("spotRadius"))) / (y - v + 1)),
                    t < e &&
                      h
                        .drawCircle(
                          (t - v) * c + _,
                          m / 2,
                          p.get("spotRadius"),
                          p.get("outlierLineColor"),
                          p.get("outlierFillColor")
                        )
                        .append(),
                    s < a &&
                      h
                  ...
                  h
                    ...
                    .append(),
                  p.get("target") &&
                    ((u = B.ceil(p.get("spotRadius"))),
                    h
                      .drawLine(
                        B.round((p.get("target") - v) * c + _),
                        B.round(m / 2 - u),
                        B.round((p.get("target") - v) * c + _),
                        B.round(m / 2 + u),
                        p.get("targetColor")
        ...
        (p = t({
          ...
          _calculatePixelDims: function (e, t, n) {
            ...
            (i = this._pxregex.exec(t)),
              (this.pixelHeight = i ? i[1] : R(n).height()),
              (i = this._pxregex.exec(e)),
              (this.pixelWidth = i ? i[1] : R(n).width());
          },
        ...
        (g = t(p, {
          init: function (e, t, n, i) {
            g._super.init.call(this, e, t, n),
              ...
              this._calculatePixelDims(e, t, this.canvas),
              (this.canvas.width = this.pixelWidth),
              (this.canvas.height = this.pixelHeight),
              (this.interact = i),
              (this.shapes = {}),
              (this.shapeseq = []),
              (this.currentTargetShapeId = U),
              R(this.canvas).css({
          ...
          _drawShape: function (e, t, n, i, r) {
            var o,
              s,
              a = this._getContext(n, i, r);
            for (
              a.beginPath(),
                a.moveTo(t[0][0] + 0.5, t[0][1] + 0.5),
                o = 1,
                s = t.length;
              o < s;
              o++
            )
              a.lineTo(t[o][0] + 0.5, t[o][1] + 0.5);
            n !== U && a.stroke(),
              i !== U && a.fill(),
              this.targetX !== U &&
                this.targetY !== U &&
          ...
          replaceWithShape: function (e, t) {
            var n,
              i = this.shapeseq;
            for (this.shapes[t.id] = t, n = i.length; n--; )
              i[n] == e && (i[n] = t.id);
          ...
          replaceWithShapes: function (e, t) {
            ...
            for (i = o.length; i--; )
              s[(n = o[i])] && (o.splice(i, 1), delete this.shapes[n], (r = i));
            for (i = t.length; i--; )
              o.splice(r, 0, t[i].id), (this.shapes[t[i].id] = t[i]);
          },
          insertAfterShape: function (e, t) {
            var n,
              i = this.shapeseq;
            for (n = i.length; n--; )
              if (i[n] === e)
                return i.splice(n + 1, 0, t.id), void (this.shapes[t.id] = t);
          },
          removeShapeId: function (e) {
            var t,
              n = this.shapeseq;
          ...
          render: function () {
            ...
            for (
              ...
              this["_draw" + (e = i[n[t]]).type].apply(this, e.args);
        ...
        (m = t(p, {
          ...
          _drawShape: function (e, t, n, i, r) {
            ...
            return (
              ...
              (s =
                n === U
                  ? ' stroked="false" '
                  : ' strokeWeight="' + r + 'px" strokeColor="' + n + '" '),
              (a =
                i === U
                  ? ' filled="false"'
                  : ' fillColor="' + i + '" filled="true" '),
              (l = h[0] === h[h.length - 1] ? "x " : ""),
          ...
          _drawCircle: function (e, t, n, i, r, o, s) {
            return (
              ...
              (r === U
                ? ' stroked="false" '
                : ' strokeWeight="' + s + 'px" strokeColor="' + r + '" ') +
              (o === U
                ? ' filled="false"'
          ...
          _drawPieSlice: function (e, t, n, i, r, o, s, a) {
            ...
            if (r === o) return "";
            if (
              (o - r == 2 * B.PI && ((r = 0), (o = 2 * B.PI)),
              (u = t + B.round(B.cos(r) * i)),
              (c = n + B.round(B.sin(r) * i)),
              (h = t + B.round(B.cos(o) * i)),
              (f = n + B.round(B.sin(o) * i)),
              u === h && c === f)
            ) {
              if (o - r < B.PI) return "";
              (u = h = t + i), (c = f = n);
            }
            return u === h && c === f && o - r < B.PI
              ? ""
              : ((l = [t - i, n - i, t + i, n + i, u, c, h, f]),
                (d =
                  s === U
                    ? ' stroked="false" '
                    : ' strokeWeight="1px" strokeColor="' + s + '" '),
                (p =
                  a === U
                    ? ' filled="false"'
          ...
          replaceWithShapes: function (e, t) {
            var n,
              ...
              o = t.length;
            for (n = 0; n < o; n++)
              r += this["_draw" + t[n].type].apply(this, t[n].args);
            for (i[0].outerHTML = r, n = 1; n < e.length; n++)
              R("#jqsshape" + e[n]).remove();
          },
          insertAfterShape: function (e, t) {
            var n = R("#jqsshape" + e),
              i = this["_draw" + t.type].apply(this, t.args);
      ...
      "function" == typeof define && define.amd
        ? define(["jquery"], e)
        : jQuery && !jQuery.fn.sparkline && e(jQuery);
  })(document, Math);
var List = (function (n) {
  var i = {};
  function r(e) {
      ...
      return function (e, t, n) {
        ...
        (this.values = function (e, t) {
          ...
          (this.matching = function () {
            return (
              (o.filtered && o.searched && r.found && r.filtered) ||
              (o.filtered && !o.searched && r.filtered) ||
              (!o.filtered && o.searched && r.found) ||
              (!o.filtered && !o.searched)
            );
          }),
  ...
  function (e, t) {
    e.exports = function (e, t, n, i) {
      return ((i = i || {}).test && i.getElementsByClassName) ||
        (!i.test && document.getElementsByClassName)
        ? ((s = e),
          (a = t),
          n ? s.getElementsByClassName(a)[0] : s.getElementsByClassName(a))
        : (i.test && i.querySelector) || (!i.test && document.querySelector)
        ? ((r = e),
          (o = "." + (o = t)),
          n ? r.querySelector(o) : r.querySelectorAll(o))
        : (function (e, t, n) {
            for (
              var i = [],
  ...
  function (e, t) {
    e.exports = function (e) {
      ...
      for (var n = [], i = 0; i < e.length; i++)
        (Object.prototype.hasOwnProperty.call(e, i) || i in e) && n.push(e[i]);
      return n.length ? n : [];
    };
  },
  function (e, t) {
  ...
  function (e, t) {
    e.exports = function (o) {
      return (
        (o.handlers.filterStart = o.handlers.filterStart || []),
        (o.handlers.filterComplete = o.handlers.filterComplete || []),
        function (e) {
          if (
            (o.trigger("filterStart"),
            (o.i = 1),
            o.reset.filter(),
            void 0 === e)
          )
  ...
  function (e, t, n) {
    ...
    e.exports = function (o, s) {
      ...
      var l = {
        search: function (e, t) {
          for (
            var n = s.multiSearch ? e.replace(/ +$/, "").split(/ +/) : [e],
              i = 0,
              r = o.items.length;
            i < r;
            i++
          )
            l.item(o.items[i], t, n);
        },
        item: function (e, t, n) {
          for (var i = !0, r = 0; r < n.length; r++) {
            for (var o = !1, s = 0, a = t.length; s < a; s++)
              l.values(e.values(), t[s], n[r]) && (o = !0);
            o || (i = !1);
          }
          e.found = i;
        },
      ...
      return (
        i.bind(u(o.listContainer, s.searchClass), "keyup", function (e) {
      ...
      (i = {
        start: function () {
          (a.listClass = "list"),
            ...
            a.listContainer &&
              ((a.list = c(a.listContainer, a.listClass, !0)),
              (a.parse = o(13)(a)),
              (a.templater = o(16)(a)),
              (a.search = o(14)(a)),
              (a.filter = o(9)(a)),
              (a.sort = o(15)(a)),
              (a.fuzzySearch = o(10)(a, n.fuzzySearch)),
              this.handlers(),
              this.items(),
              this.pagination(),
              a.update());
        ...
        pagination: function () {
          if (void 0 !== n.pagination) {
            !0 === n.pagination && (n.pagination = [{}]),
              void 0 === n.pagination[0] && (n.pagination = [n.pagination]);
            for (var e = 0, t = n.pagination.length; e < t; e++)
              r(n.pagination[e]);
          }
        },
      }),
        ...
        (this.toJSON = function () {
          for (var e = [], t = 0, n = a.items.length; t < n; t++)
            e.push(a.items[t].values());
          return e;
        }),
          ...
          if (0 !== e.length) {
            if (!t) {
              ...
              for (var r = 0, o = e.length; r < o; r++) {
                var s;
                (i = a.items.length > a.page),
                  (s = new l(e[r], void 0, i)),
                  a.items.push(s),
                  n.push(s);
              }
              return a.update(), n;
        ...
        (this.remove = function (e, t, n) {
          for (var i = 0, r = 0, o = a.items.length; r < o; r++)
            a.items[r].values()[e] == t &&
              (a.templater.remove(a.items[r], n),
              a.items.splice(r, 1),
              o--,
              r--,
              i++);
        ...
        (this.update = function () {
          ...
          for (var n = 0; n < t; n++)
            e[n].matching() &&
            a.matchingItems.length + 1 >= a.i &&
            a.visibleItems.length < a.page
              ? (e[n].show(),
                a.visibleItems.push(e[n]),
                a.matchingItems.push(e[n]))
              : (e[n].matching() && a.matchingItems.push(e[n]), e[n].hide());
    ...
    e.exports = function (d) {
      var n = function (e, t) {
          ...
          for (var h = 1; h <= s; h++) {
            var f = a === h ? "active" : "";
            p.number(h, u, c, a, l)
              ? ((n = e.add({ page: h, dotted: !1 })[0]),
                f && m(n.elm).add(f),
                g(n.elm, h, o))
              : p.dotted(e, h, u, c, a, l, e.size()) &&
                ((n = e.add({ page: "...", dotted: !0 })[0]),
                m(n.elm).add("disabled"));
          }
        },
        p = {
          number: function (e, t, n, i, r) {
            return (
              this.left(e, t) || this.right(e, n) || this.innerWindow(e, i, r)
            );
          },
          left: function (e, t) {
            return e <= t;
          ...
          dotted: function (e, t, n, i, r, o, s) {
            return (
              this.dottedLeft(e, t, n, i, r, o) ||
              this.dottedRight(e, t, n, i, r, o, s)
            );
          },
          dottedLeft: function (e, t, n, i, r, o) {
            return (
              t == n + 1 && !this.innerWindow(t, r, o) && !this.right(t, i)
            );
          },
          dottedRight: function (e, t, n, i, r, o, s) {
            return (
              !e.items[s - 1].values().dotted &&
              t == i &&
              !this.innerWindow(t, r, o) &&
              !this.right(t, i)
            );
          },
        },
  ...
  function (e, t) {
    e.exports = function (n) {
      var i,
        ...
        s = {
          ...
          setColumns: function () {
            0 !== n.items.length &&
              void 0 === r &&
              (r =
                void 0 === n.searchColumns
                  ? s.toArray(n.items[0].values())
                  : n.searchColumns);
          },
          setSearchString: function (e) {
            (e = (e = n.utils.toString(e).toLowerCase()).replace(
              /[-[\]{}()*+?.,\\^$|#]/g,
              "\\$&"
            )),
              (o = e);
        ...
        a = {
          ...
          values: function (e, t) {
            return !!(
              e.hasOwnProperty(t) &&
              ((i = n.utils.toString(e[t]).toLowerCase()),
              "" !== o && -1 < i.search(o))
            );
          },
          reset: function () {
        ...
        l = function (e) {
          return (
            ...
            s.setColumns(),
            "" === o ? a.reset() : ((n.searched = !0), t ? t(o, r) : a.list()),
            n.update(),
      ...
      return (
        ...
        n.utils.events.bind(
          n.utils.getByClass(n.listContainer, n.searchClass),
          "keyup",
          function (e) {
            var t = e.target || e.srcElement;
  ...
  function (e, t) {
    e.exports = function (o) {
      var s = {
          els: void 0,
          clear: function () {
            for (var e = 0, t = s.els.length; e < t; e++)
              o.utils.classes(s.els[e]).remove("asc"),
          ...
          getOrder: function (e) {
            ...
            return "asc" == t || "desc" == t
              ? t
              : o.utils.classes(e).has("desc")
              ? "asc"
              : o.utils.classes(e).has("asc")
              ? "desc"
              : "asc";
          },
          ...
          setOrder: function (e) {
            for (var t = 0, n = s.els.length; t < n; t++) {
              ...
              if (o.utils.getAttribute(i, "data-sort") === e.valueName) {
                ...
                "asc" == r || "desc" == r
                  ? r == e.order && o.utils.classes(i).add(e.order)
                  : o.utils.classes(i).add(e.order);
              }
            }
          },
        },
        e = function () {
          ...
          e
            ? ((i.valueName = o.utils.getAttribute(e, "data-sort")),
              s.getInSensitive(e, i),
              (i.order = s.getOrder(e)))
            : (((i = arguments[1] || i).valueName = arguments[0]),
              (i.order = i.order || "asc"),
              (i.insensitive = void 0 === i.insensitive || i.insensitive)),
            s.clear(),
            s.setOrder(i);
          var t,
            n = i.sortFunction || o.sortFunction || null,
            r = "desc" === i.order ? -1 : 1;
          (t = n
            ? function (e, t) {
                return n(e, t, i) * r;
            ...
            : function (e, t) {
                ...
                return (
                  (n.alphabet = o.alphabet || i.alphabet || void 0),
                  !n.alphabet &&
                    i.insensitive &&
                    (n = o.utils.naturalSort.caseInsensitive),
                  n(e.values()[i.valueName], t.values()[i.valueName]) * r
                );
              }),
            o.items.sort(t),
            o.update(),
            o.trigger("sortComplete");
        };
      return (
        (o.handlers.sortStart = o.handlers.sortStart || []),
        (o.handlers.sortComplete = o.handlers.sortComplete || []),
        (s.els = o.utils.getByClass(o.listContainer, o.sortClass)),
        o.utils.events.bind(s.els, "click", e),
        o.on("searchStart", s.clear),
        o.on("filterStart", s.clear),
        e
      );
    };
  },
    ...
    var n = function (l) {
      ...
      (this.clearSourceItem = function (e, t) {
        for (var n = 0, i = t.length; n < i; n++) {
          var r;
          if (t[n].data)
            for (var o = 0, s = t[n].data.length; o < s; o++)
              e.setAttribute("data-" + t[n].data[o], "");
          else
            t[n].attr && t[n].name
              ? (r = l.utils.getByClass(e, t[n].name, !0)) &&
                r.setAttribute(t[n].attr, "")
              : (r = l.utils.getByClass(e, t[n], !0)) && (r.innerHTML = "");
          r = void 0;
        }
        return e;
      }),
        ...
        (this.get = function (e, t) {
          ...
          for (var n = {}, i = 0, r = t.length; i < r; i++) {
            var o;
            if (t[i].data)
              for (var s = 0, a = t[i].data.length; s < a; s++)
                n[t[i].data[s]] = l.utils.getAttribute(
                  e.elm,
                  "data-" + t[i].data[s]
                );
            else
              t[i].attr && t[i].name
                ? ((o = l.utils.getByClass(e.elm, t[i].name, !0)),
                  (n[t[i].name] = o ? l.utils.getAttribute(o, t[i].attr) : ""))
                : ((o = l.utils.getByClass(e.elm, t[i], !0)),
                  (n[t[i]] = o ? o.innerHTML : ""));
            o = void 0;
          }
          return n;
              ...
              i = (function (e) {
                for (var t = 0, n = l.valueNames.length; t < n; t++)
                  if (l.valueNames[t].data) {
                    for (
                      var i = l.valueNames[t].data, r = 0, o = i.length;
                      r < o;
                      r++
                    )
                      if (i[r] === e) return { data: e };
                  } else {
                    if (
                      l.valueNames[t].attr &&
                      l.valueNames[t].name &&
                      l.valueNames[t].name == e
                    )
                      return l.valueNames[t];
                    if (l.valueNames[t] === e) return e;
                  }
              })(e);
            i &&
              (i.data
                ? r.elm.setAttribute("data-" + i.data, t)
                : i.attr && i.name
                ? (n = l.utils.getByClass(r.elm, i.name, !0)) &&
                  n.setAttribute(i.attr, t)
                : (n = l.utils.getByClass(r.elm, i, !0)) && (n.innerHTML = t),
              (n = void 0));
          };
        ...
        (this.hide = function (e) {
          void 0 !== e.elm &&
            e.elm.parentNode === l.list &&
            l.list.removeChild(e.elm);
        }),
        (this.clear = function () {
          if (l.list.hasChildNodes())
            for (; 1 <= l.list.childNodes.length; )
              l.list.removeChild(l.list.firstChild);
        }),
        (n = u.getItemSource(l.item)) &&
          (n = u.clearSourceItem(n, l.valueNames));
    };
    e.exports = function (e) {
      return new n(e);
    };
  ...
  function (e, t, n) {
    ...
    function r(e, t) {
      for (
        var n = (e += "").length, i = (t += "").length, r = 0, o = 0;
        r < n && o < i;
  ...
  function (e, t) {
    e.exports = function (e, r, t) {
      ...
      -1 != c &&
        ((u = Math.min(l(0, c), u)),
        -1 != (c = e.lastIndexOf(r, s + r.length)) &&
          (u = Math.min(l(0, c), u)));
      var h,
        f,
        d = 1 << (r.length - 1);
